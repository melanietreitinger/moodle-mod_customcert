...
$string['error:atleastone'] = 'You must have at least one grade range configured';
$string['error:rangetext'] = 'You must provide string representation for the grade range';
$string['error:rangemax'] = 'The maximum value must be greater than the minimum value';
$string['itemranges'] = 'Grade ranges';
...
$string['pluginname'] = 'Grade Legend';
